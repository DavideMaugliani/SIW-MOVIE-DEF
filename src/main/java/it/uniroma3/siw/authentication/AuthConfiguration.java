...
//                .requestMatchers("/**").permitAll()
                ...
                .requestMatchers(HttpMethod.GET,"/default/**").hasAnyAuthority(DEFAULT_ROLE,ADMIN_ROLE)
                .requestMatchers(HttpMethod.POST,"/default/**").hasAnyAuthority(DEFAULT_ROLE,ADMIN_ROLE)
